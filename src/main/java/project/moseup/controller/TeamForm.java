...
public class TeamForm {
	...
	@NotNull(message = "습관 시작일은 필수 입력값 입니다. :)")
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@FutureOrPresent(message = "오늘 이전의 날짜는 설정 할 수 없습니다. :)")		// @FutureOrPresent : Now이거나 미래의 날짜, 시간이어야 한다.
	private LocalDate startDate;			//습관 시작일
	
	@NotNull(message = "습관 종료일은 필수 입력값 입니다. :)")
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	@FutureOrPresent(message = "오늘 이전의 날짜는 설정 할 수 없습니다. :)")

...
public class SearchController {
	...
	//필터2 검색 페이징
	@GetMapping("/filter")
    public String filter2(@RequestParam(required = false, defaultValue = "") String keyword, String filter1, String filter2, Model model, 
		    ...
		    System.out.println("키워드 3번 = " + keyword);
			System.out.println("필터1 3번 = " + filter1);
			System.out.println("필터2 3번 = " + filter2);

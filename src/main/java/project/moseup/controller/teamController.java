...
public class teamController {
	...
	public String  createTeam(@Valid TeamForm teamForm, BindingResult results) {
		...
		if (results.hasErrors()) {	// result안에 에러가 있으면
			return "members/createMemberForm"; // 에러를 createMemberForm으로 가져감
		}
		...
		team.setTeamDate(localDateTime);
